...
namespace QLKS
{
    public partial class LsDrinkForm : UserControl
    {
        protected internal static LsDrinkForm _instance;
        ...
        protected internal static LsDrinkForm Instance()
        {
            if (_instance == null)
            {
                _instance = new LsDrinkForm();
            }
            return _instance;
        }
        ...
        private void LsDrinkForm_Load(object sender, EventArgs e)
        {
            loadListType(1);
        }
    }
